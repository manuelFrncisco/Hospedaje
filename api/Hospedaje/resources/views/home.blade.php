...
@section('content')
    ...
    <section class="info">
        ...
        <div>
            <p class="">Imagina tener el mundo de los alojamientos al alcance de tus manos. Con nuestra plataforma,
                encontrar
    ...
    <section class="mb-5 pb-5">
        ...
        <div class="m-4 p-2 row">
            <h1>Alojamientos más comentados</h1>

            @foreach ($popularLodgingsComments as $lodging)
                <div class="m-4 col">
                    <div class="card" style="width: 18rem;">
                        <a class="text-decoration-none text-black" href="{{ route('show', $lodging->id) }}">
                            <img src="{{ $lodging->image }}" class="card-img-top" width="200" height="200">
